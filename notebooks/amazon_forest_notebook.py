...
thresholds = [0.25] * len(labels_set)
...
# tags_s = pd.Series(list(chain.from_iterable(predicted_labels)tags_s = pd.Series(list(chain.from_iterable(predicted_labels))).value_counts()
# fig, ax = plt.subplots(figsize=(16, 8))
